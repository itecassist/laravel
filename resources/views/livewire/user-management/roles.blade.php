    ...
    <!-- Default box -->
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-md-5">
                    <h3 class="card-title"><a href="{{ route('user-management.roles') }}">{{ __('user-management/roles.title') }}</a></h3>
                </div>
                <div class="col-md-4"><button class="btn btn-primary btn-sm" wire:click="createRoles"><i class="fa fa-plus"></i> {{ __('global.create_new') }}</button></div>
                <div class="col-md-3">
							...
							<td>
                                <div class="dropleft">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#" wire:click="editRoles({{ $rec->id }})"> {{ __('global.edit') }} </a>
                                        <a class="dropdown-item" href="#" wire:click="deleteRoles({{ $rec->id }})"> {{ __('global.delete') }} </a>
                                    </div>
                                </div>
                            </td>
                        </tr>
